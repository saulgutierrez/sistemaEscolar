 ...
 * @author USER
 */
public class PanelProfesor extends javax.swing.JFrame {
    ...
    private void btn_perfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_perfilMouseClicked
        ...
        try {
            con.conexionProfesor(parts[0], this, 0, null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelProfesor().setVisible(true);
            }
        });
    }
